...
export const experience = [
  ...
  },
  {
    ...
    company: "Client & Freelance Projects",
    location: "Indore, India",
    duration: "2024 – 2025",
    responsibilities: [
      "Delivered marketing websites and admin dashboards for multiple clients",
      "Converted Figma designs into pixel-accurate responsive interfaces",
      "Set up reusable component libraries and shared layout systems",
    ],
  },
] as const;
